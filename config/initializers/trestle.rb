Trestle.configure do |config|
  ...
  #
  config.site_title = "Pdc Backend"
  # config.auth.locale = false
  ...
  #
  config.auth.user_admin = -> { :"auth/staffs" }
  ...
  #
  config.auth.enable_login = false
  config.auth.enable_logout = false
